...
#
/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100/5steps/il2a.json
/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100/10steps/il2a.json
/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100-byol/5steps/il2a.json
/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100-byol/10steps/il2a.json
