...
#/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100/10steps/pass.json
#/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100-byol/5steps/pass.json
#/root/miniconda3/envs/torch/bin/python main.py --config=./exps_semi_new/imagenet100-byol/10steps/pass.json
#
