...
CUDA_VISIBLE_DEVICES=4 python main.py --config=./exps_semi_new/cub200/5steps/rmm-foster.json &
CUDA_VISIBLE_DEVICES=5 python main.py --config=./exps_semi_new/cub200/10steps/rmm-foster.json &
CUDA_VISIBLE_DEVICES=6 python main.py --config=./exps_semi_new/cub200-byol/5steps/rmm-foster.json &
CUDA_VISIBLE_DEVICES=7 python main.py --config=./exps_semi_new/cub200-byol/10steps/rmm-foster.json

CUDA_VISIBLE_DEVICES=0 python main.py --config=./exps_semi_new/cub200/5steps/simplecil.json &
CUDA_VISIBLE_DEVICES=1 python main.py --config=./exps_semi_new/cub200/10steps/simplecil.json &
CUDA_VISIBLE_DEVICES=2 python main.py --config=./exps_semi_new/cub200-byol/5steps/simplecil.json &
CUDA_VISIBLE_DEVICES=3 python main.py --config=./exps_semi_new/cub200-byol/10steps/simplecil.json &

CUDA_VISIBLE_DEVICES=4 python main.py --config=./exps_semi_new/cub200/5steps/ssre.json &
CUDA_VISIBLE_DEVICES=5 python main.py --config=./exps_semi_new/cub200/10steps/ssre.json &
CUDA_VISIBLE_DEVICES=6 python main.py --config=./exps_semi_new/cub200-byol/5steps/ssre.json &
CUDA_VISIBLE_DEVICES=7 python main.py --config=./exps_semi_new/cub200-byol/10steps/ssre.json

CUDA_VISIBLE_DEVICES=0 python main.py --config=./exps_semi_new/cub200/5steps/der.json &
CUDA_VISIBLE_DEVICES=1 python main.py --config=./exps_semi_new/cub200/10steps/der.json &
CUDA_VISIBLE_DEVICES=2 python main.py --config=./exps_semi_new/cub200-byol/5steps/der.json &
CUDA_VISIBLE_DEVICES=3 python main.py --config=./exps_semi_new/cub200-byol/10steps/der.json &
...
CUDA_VISIBLE_DEVICES=4 python main.py --config=./exps_semi_new/cub200/5steps/pass.json &
CUDA_VISIBLE_DEVICES=5 python main.py --config=./exps_semi_new/cub200/10steps/pass.json &
CUDA_VISIBLE_DEVICES=6 python main.py --config=./exps_semi_new/cub200-byol/5steps/pass.json &
CUDA_VISIBLE_DEVICES=7 python main.py --config=./exps_semi_new/cub200-byol/10steps/pass.json


CUDA_VISIBLE_DEVICES=0 python main.py --config=./exps_semi_new/cub200/5steps/beef.json &
CUDA_VISIBLE_DEVICES=1 python main.py --config=./exps_semi_new/cub200/10steps/beef.json &
CUDA_VISIBLE_DEVICES=2 python main.py --config=./exps_semi_new/cub200-byol/5steps/beef.json &
CUDA_VISIBLE_DEVICES=3 python main.py --config=./exps_semi_new/cub200-byol/10steps/beef.json &
